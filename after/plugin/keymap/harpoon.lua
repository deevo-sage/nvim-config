...
nnoremap("L", function() require("harpoon.ui").toggle_quick_menu() end, silent)
nnoremap("<leader>tc", function() require("harpoon.cmd-ui").toggle_quick_menu() end, silent)
nnoremap("<C-b>", function() require("harpoon.ui").nav_file(1) end, silent)
nnoremap("<C-y>", function() require("harpoon.ui").nav_file(2) end, silent)
